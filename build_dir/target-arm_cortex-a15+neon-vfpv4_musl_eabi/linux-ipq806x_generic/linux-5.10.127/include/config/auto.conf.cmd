...
ifneq "$(KERNELVERSION)" "5.10.127"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-openwrt-linux-muslgnueabi-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-openwrt-linux-muslgnueabi-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm"
include/config/auto.conf: FORCE
...
ifneq "$(CC_VERSION_TEXT)" "arm-openwrt-linux-muslgnueabi-gcc (OpenWrt GCC 11.3.0 r20017-eb7d2abbf0) 11.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "arm-openwrt-linux-muslgnueabi-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "arm-openwrt-linux-muslgnueabi-objcopy"
include/config/auto.conf: FORCE
endif
