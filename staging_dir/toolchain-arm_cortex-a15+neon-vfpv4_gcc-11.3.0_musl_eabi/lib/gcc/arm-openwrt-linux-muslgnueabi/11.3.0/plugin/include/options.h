...
enum opt_code
{
  ...
  OPT_fhonour_copts = 1142,                  /* -fhonour-copts */
  ...
  OPT_fweak_templates = 1606,                /* -fweak-templates */
  OPT_fweb = 1607,                           /* -fweb */
  ...
  OPT_list = 1677,                           /* -list */
  OPT_mabi_ = 1678,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1679,             /* -mabort-on-noreturn */
  OPT_mandroid = 1680,                       /* -mandroid */
  OPT_mapcs = 1681,                          /* -mapcs */
  OPT_mapcs_frame = 1682,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1683,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1684,              /* -mapcs-stack-check */
  OPT_march_ = 1685,                         /* -march= */
  OPT_marm = 1686,                           /* -marm */
  OPT_masm_syntax_unified = 1687,            /* -masm-syntax-unified */
  OPT_mbe32 = 1688,                          /* -mbe32 */
  OPT_mbe8 = 1689,                           /* -mbe8 */
  OPT_mbig_endian = 1690,                    /* -mbig-endian */
  OPT_mbionic = 1691,                        /* -mbionic */
  OPT_mbranch_cost_ = 1692,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1693,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1694,     /* -mcaller-super-interworking */
  OPT_mcmse = 1695,                          /* -mcmse */
  OPT_mcpu_ = 1696,                          /* -mcpu= */
  OPT_mfdpic = 1697,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1698,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1699,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1700,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1701,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1702,                  /* -mfp16-format= */
  OPT_mfpu_ = 1703,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1704,             /* -mgeneral-regs-only */
  OPT_mglibc = 1705,                         /* -mglibc */
  /* OPT_mhard_float = 1706, */              /* -mhard-float */
  OPT_mlibarch_ = 1707,                      /* -mlibarch= */
  OPT_mlittle_endian = 1708,                 /* -mlittle-endian */
  OPT_mlong_calls = 1709,                    /* -mlong-calls */
  OPT_mmusl = 1710,                          /* -mmusl */
  OPT_mneon_for_64bits = 1711,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1712,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1713,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1714,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1715,               /* -mprint-tune-info */
  OPT_mpure_code = 1716,                     /* -mpure-code */
  OPT_mrestrict_it = 1717,                   /* -mrestrict-it */
  OPT_msched_prolog = 1718,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1719,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1720,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1721, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1722,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1723,                         /* -mthumb */
  OPT_mthumb_interwork = 1724,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1725,                  /* -mtls-dialect= */
  OPT_mtp_ = 1726,                           /* -mtp= */
  OPT_mtpcs_frame = 1727,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1728,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1729,                         /* -mtune= */
  OPT_muclibc = 1730,                        /* -muclibc */
  OPT_munaligned_access = 1731,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1732,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1733,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1734,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1735,              /* -mword-relocations */
  OPT_n = 1736,                              /* -n */
  ...
  OPT_time = 1861,                           /* -time */
  OPT_time_ = 1862,                          /* -time= */
  OPT_tno_android_cc = 1863,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1864,                 /* -tno-android-ld */
  OPT_traditional = 1865,                    /* -traditional */
  OPT_traditional_cpp = 1866,                /* -traditional-cpp */
  OPT_tree_stats = 1867,                     /* -tree-stats */
  OPT_trigraphs = 1868,                      /* -trigraphs */
  OPT_type_stats = 1869,                     /* -type-stats */
  OPT_u = 1870,                              /* -u */
  OPT_undef = 1871,                          /* -undef */
  OPT_v = 1872,                              /* -v */
  OPT_version = 1873,                        /* -version */
  OPT_w = 1874,                              /* -w */
  OPT_wrapper = 1875,                        /* -wrapper */
  OPT_x = 1876,                              /* -x */
  OPT_z = 1877,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
