/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/builder/shared-workdir/build/build_dir/toolchain-arm_cortex-a15+neon-vfpv4_gcc-11.3.0_musl_eabi/gcc-11.3.0/gcc/config/arm/arm.md'.  */
